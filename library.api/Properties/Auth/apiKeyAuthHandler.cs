...
namespace library.api.Properties.Auth
{
    ...
    {
        public apiKeyAuthHandler(IOptionsMonitor<apiKeyAuthSchemeOptions>
        ...
        protected override Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            var claims = new[] {
            new Claim(ClaimTypes. Email, "nick@nickchapsas.com"),
            new Claim(ClaimTypes.Name, "nickchapsas.com") ,};


            var claimsIdentity = new ClaimsIdentity(claims, "ApiKey");
            var ticket = new AuthenticationTicket(
            new
            ClaimsPrincipal(claimsIdentity), Scheme.Name);
